...
public class UnitConversion extends javax.swing.JFrame {
    ...
    private double foot;
    private double mile;
    // the following variables are for the weight converter tab by Berlin Morales
    private double ounce;
    private double pound;
    // end weight variables by Berlin 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // this is for the weight converter
          if(!jTextField3.getText().equals("") && jTextField4.getText().equals(""))
         {
            ounce = Double.parseDouble(jTextField3.getText());
            pound = ounce*(1/16);    
            jLabel7.setText("ounce: " + ounce);
            jLabel6.setText("pounds: "+ pound);
         }
           
          else if(jTextField3.getText().equals("") && !jTextField4.getText().equals(""))
         {
             pound=Double.parseDouble(jTextField4.getText());
             ounce= pound*16;
            jLabel7.setText("ounce: " + ounce);
            jLabel6.setText("pounds: "+ pound);
         }
